...
$sql = "SELECT nom_cabane FROM cabanes WHERE id_cabane = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $id_cabane);
$stmt->execute();
$stmt->bind_result($nom_cabane);
$stmt->fetch();
$stmt->close();
$conn->close();
?>
...
<body>
    ...
    <form action="envoie_formulaire.php" method="POST">
        ...
        <input type="hidden" name="nom_cabane" value="<?php echo htmlspecialchars($nom_cabane, ENT_QUOTES, 'UTF-8'); ?>">
